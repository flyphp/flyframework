<?php namespace Fly\Database\Query;

use Closure;
use Fly\Support\Collection;
use Fly\Database\ConnectionInterface;
use Fly\Database\Query\Grammars\Grammar;
...
class Builder {
	 ...
	 *
	 * @param  \Fly\Database\ConnectionInterface  $connection
	 * @param  \Fly\Database\Query\Grammars\Grammar  $grammar
	 * @param  \Fly\Database\Query\Processors\Processor  $processor
	 * @return void
	 */
	 ...
	 *
	 * @param  \Fly\Database\Query\Builder|\Closure  $query
	 * @param  bool $all
	 * @return \Fly\Database\Query\Builder|static
	 */
	 ...
	 *
	 * @return \Fly\Database\ConnectionInterface
	 */
