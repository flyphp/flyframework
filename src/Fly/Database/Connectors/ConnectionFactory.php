<?php namespace Fly\Database\Connectors;

use PDO;
use Fly\Container\Container;
use Fly\Database\MySqlConnection;
use Fly\Database\SQLiteConnection;
use Fly\Database\PostgresConnection;
use Fly\Database\SqlServerConnection;
...
class ConnectionFactory {
	 ...
	 *
	 * @param  array  $config
	 * @return \Fly\Database\Connectors\ConnectorInterface
	 *
