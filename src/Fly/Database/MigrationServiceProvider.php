...
use Fly\Database\Migrations\Migrator;
use Fly\Database\Migrations\MigrationCreator;
use Fly\Database\Console\Migrations\ResetCommand;
use Fly\Database\Console\Migrations\RefreshCommand;
use Fly\Database\Console\Migrations\InstallCommand;
use Fly\Database\Console\Migrations\MigrateCommand;
use Fly\Database\Console\Migrations\RollbackCommand;
use Fly\Database\Console\Migrations\MigrateMakeCommand;
use Fly\Database\Migrations\DatabaseMigrationRepository;
...
class MigrationServiceProvider extends ServiceProvider {
	...
	public function register()
	{
		...
		// all of the migration related commands that are used by the "FlyConsole" CLI
	...
	protected function registerCommands()
	{
		...
		// be resolved in the FlyConsole start file and registered on the console.
		...
		// register them with the FlyConsole start event so that these are available
		// when the FlyConsole application actually starts up and is getting used.
		$this->commands(
