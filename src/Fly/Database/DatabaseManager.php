...
class DatabaseManager implements ConnectionResolverInterface {
	 ...
	 *
	 * @var \Fly\Database\Connectors\ConnectionFactory
	 */
	protected $factory;
	 ...
	 * @param  \Fly\Database\Connectors\ConnectionFactory  $factory
	 * @return void
	 */
	...
	protected function prepare(Connection $connection)
	{
		...
		// to caching both fluent queries and FlyORM queries that are executed.
		$app = $this->app;
