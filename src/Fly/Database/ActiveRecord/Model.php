...
use Fly\Support\Contracts\JsonableInterface;
use Fly\Support\Contracts\ArrayableInterface;
use Fly\Database\ActiveRecord\Relations\Relation;
...
use Fly\Database\ActiveRecord\Relations\BelongsToMany;
use Fly\Database\ActiveRecord\Relations\HasManyThrough;
use Fly\Database\ConnectionResolverInterface as Resolver;
...
abstract class Model implements ArrayAccess, ArrayableInterface, JsonableInterface {
	 ...
	 *
	 * @var \Fly\Database\ConnectionResolverInterface
	 */
	...
	/**
	 * Create a new FlyORM model instance.
	 *
	 ...
	 *
	 * @param  array  $attributes
	 * @return \Fly\Database\ActiveRecord\Model|static
	 *
	...
	public function newInstance($attributes = array(), $exists = false)
	{
		...
		// hydration of new objects via the FlyORM query builder instances.
	 ...
	 *
	 * @param  array  $attributes
	 * @return \Fly\Database\ActiveRecord\Model|null
	 */
	 ...
	 *
	 * @return \Fly\Database\ActiveRecord\Builder|static
	 */
	 ...
	 *
	 * @param  array  $columns
	 * @return \Fly\Database\ActiveRecord\Collection|static[]
	 */
	 ...
	 * @param  mixed  $id
	 * @param  array  $columns
	 * @return \Fly\Database\ActiveRecord\Model|Collection|static
	 */
	 ...
	 * @return \Fly\Database\ActiveRecord\Relations\HasOne
	 */
	 ...
	 * @param  string  $id
	 * @param  string  $localKey
	 * @return \Fly\Database\ActiveRecord\Relations\MorphOne
	 */
	...
	public function belongsTo($related, $foreignKey = null, $otherKey = null, $relation = null)
	{
		...
		// Once we have the foreign key names, we'll just create a new FlyORM query
	 ...
	 * @param  string  $foreignKey
	 * @param  string  $localKey
	 * @return \Fly\Database\ActiveRecord\Relations\HasMany
	 */
	 ...
	 * @return \Fly\Database\ActiveRecord\Relations\HasManyThrough
	 */
	 ...
	 * @param  string  $id
	 * @param  string  $localKey
	 * @return \Fly\Database\ActiveRecord\Relations\MorphMany
	 */
	 ...
	 * @param  string  $otherKey
	 * @param  string  $relation
	 * @return \Fly\Database\ActiveRecord\Relations\BelongsToMany
	 */
	 ...
	 * @param  string  $otherKey
	 * @param  bool    $inverse
	 * @return \Fly\Database\ActiveRecord\Relations\MorphToMany
	 */
	...
	public static function flushEventListeners()
	{
		...
		foreach ($instance->getObservableEvents() as $event)
		{
			static::$dispatcher->forget("activerecord.{$event}: ".get_called_class());
		}
	}
	...
	protected static function registerModelEvent($event, $callback)
	{
		if (isset(static::$dispatcher))
		{
			...
			static::$dispatcher->listen("activerecord.{$event}: {$name}", $callback);
		}
	}
	 ...
	 *
	 * @param  \Fly\Database\ActiveRecord\Builder  $query
	 * @return bool
	 */
	...
	protected function fireModelEvent($event, $halt = true)
	{
		...
		$event = "activerecord.{$event}: ".get_class($this);
	...
	{
		$builder = $this->newActiveRecordBuilder($this->newBaseQueryBuilder());
	...
	/**
	 * Create a new ActiveRecord query builder for the model.
	 *
	 * @param  \Fly\Database\Query\Builder $query
	 * @return \Fly\Database\ActiveRecord\Builder|static
	 */
	public function newActiveRecordBuilder($query)
	{
	...
	/**
	 * Create a new FlyORM Collection instance.
	 *
	 * @param  array  $models
	 * @return \Fly\Database\ActiveRecord\Collection
	 */
	...
	protected function getRelationshipFromMethod($key, $camelKey)
	{
		...
		if ( ! $relations instanceof Relation)
		{
			throw new LogicException('Relationship method must return an object of type '
				. 'Fly\Database\ActiveRecord\Relations\Relation');
		}
	 ...
	 *
	 * @return \Fly\Database\ConnectionResolverInterface
	 */
	 ...
	 *
	 * @param  \Fly\Database\ConnectionResolverInterface  $resolver
	 * @return void
	 */
