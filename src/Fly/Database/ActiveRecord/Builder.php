...
class Builder {
	 ...
	 *
	 * @var \Fly\Database\Query\Builder
	 */
	protected $query;
	...
	/**
	 * Create a new FlyORM query builder instance.
	 *
	 ...
	 * @param  mixed  $id
	 * @param  array  $columns
	 * @return \Fly\Database\ActiveRecord\Model|static|null
	 */
	...
	public function lists($column, $key = null)
	{
		...
		// columns are returned as you would expect from these FlyORM models.
	 ...
	 * @param  int    $perPage
	 * @param  array  $columns
	 * @return \Fly\Pagination\Paginator
	 */
	 ...
	 *
	 * @param  \Fly\Pagination\Environment  $paginator
	 * @param  int    $perPage
	 * @param  array  $columns
	 * @return \Fly\Pagination\Paginator
	 */
	...
	public function getModels($columns = array('*'))
	{
		...
		// can use to populate an array with FlyORM models. We will pass columns
	 ...
	 *
	 * @param  \Fly\Database\ActiveRecord\Builder  $hasQuery
	 * @param  \Fly\Database\ActiveRecord\Relations\Relation  $relation
	 * @param  string  $operator
	 * @param  int  $count
	 * @param  string  $boolean
	 ...
	 *
	 * @param  \Fly\Database\ActiveRecord\Model  $model
	 * @return \Fly\Database\ActiveRecord\Builder
	 */
