...
use Fly\Database\ActiveRecord\ModelNotFoundException;
...
class BelongsToMany extends Relation {
	 ...
	 *
	 * @throws \Fly\Database\ActiveRecord\ModelNotFoundException
	 */
	...
	public function paginate($perPage = null, $columns = array('*'))
	{
		...
		// from the database since this isn't performed by the FlyORM builder.
	 ...
	 *
	 * @param  \Fly\Database\ActiveRecord\Builder  $query
	 * @param  \Fly\Database\ActiveRecord\Builder  $parent
	...
	{
		$query->select(new \Fly\Database\Query\Expression('count(*)'));

		$query->from($this->table.' as '.$hash = $this->getRelationCountHash());

		$key = $this->wrap($this->getQualifiedParentKeyName());

		return $query->where($hash.'.'.$this->foreignKey, '=', new \Fly\Database\Query\Expression($key));
	}
	 ...
	 *
	 * @param  \Fly\Database\ActiveRecord\Builder|null
	 * @return \Fly\Database\ActiveRecord\Relations\BelongsToMany
	 */
