<?php namespace Fly\Database\Schema;
...
class Builder {
	 ...
	 *
	 * @param  \Fly\Database\Connection  $connection
	 * @return void
	 */
	 ...
	 * @return \Fly\Database\Schema\Blueprint
	 */
	 ...
	 *
	 * @param  \Fly\Database\Schema\Blueprint  $blueprint
	 * @return void
	 */
