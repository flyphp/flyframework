...
use Fly\Database\Orm\Relations\Pivot;
...
use Fly\Database\Orm\Relations\Relation;
...
use Fly\Database\Orm\Relations\MorphToMany;
use Fly\Database\Orm\Relations\BelongsToMany;
...
abstract class Model implements ArrayAccess, ArrayableInterface, JsonableInterface {
	 ...
	 *
	 * @param  array  $attributes
	 * @return \Fly\Database\Orm\Model|static
	 *
	 ...
	 *
	 * @param  array  $attributes
	 * @return \Fly\Database\Orm\Model|null
	 */
	 ...
	 *
	 * @return \Fly\Database\Orm\Builder|static
	 */
	 ...
	 *
	 * @param  array  $columns
	 * @return \Fly\Database\Orm\Collection|static[]
	 */
	 ...
	 * @param  mixed  $id
	 * @param  array  $columns
	 * @return \Fly\Database\Orm\Model|Collection|static
	 */
	 ...
	 * @return \Fly\Database\Orm\Relations\HasOne
	 */
	 ...
	 * @param  string  $id
	 * @param  string  $localKey
	 * @return \Fly\Database\Orm\Relations\MorphOne
	 */
	 ...
	 * @return \Fly\Database\Orm\Relations\BelongsTo
	 */
	 ...
	 * @param  string  $foreignKey
	 * @param  string  $localKey
	 * @return \Fly\Database\Orm\Relations\HasMany
	 */
	 ...
	 * @return \Fly\Database\Orm\Relations\HasManyThrough
	 */
	 ...
	 * @param  string  $id
	 * @param  string  $localKey
	 * @return \Fly\Database\Orm\Relations\MorphMany
	 */
	 ...
	 * @param  string  $otherKey
	 * @param  bool    $inverse
	 * @return \Fly\Database\Orm\Relations\MorphToMany
	 */
	...
	{
		$builder = $this->newFlyOrmBuilder($this->newBaseQueryBuilder());
	...
	/**
	 * Create a new FlyORM query builder for the model.
	 *
	 * @param  \Fly\Database\Query\Builder $query
	 * @return \Fly\Database\Orm\Builder|static
	 */
	public function newFlyOrmBuilder($query)
	{
	 ...
	 * @param  string  $table
	 * @param  bool    $exists
	 * @return \Fly\Database\Orm\Relations\Pivot
	 */
	...
	protected function getRelationshipFromMethod($key, $camelKey)
	{
		...
		if ( ! $relations instanceof Relation)
		{
			throw new LogicException('Relationship method must return an object of type '
				. 'Fly\Database\Orm\Relations\Relation');
		}
