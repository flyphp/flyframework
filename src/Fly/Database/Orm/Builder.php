...
class Builder {
	 ...
	 * @param  mixed  $id
	 * @param  array  $columns
	 * @return \Fly\Database\Orm\Model|static|null
	 */
	 ...
	 * @return \Fly\Database\Orm\Relations\Relation
	 */
	 ...
	 *
	 * @param  \Fly\Database\Orm\Builder  $hasQuery
	 * @param  \Fly\Database\Orm\Relations\Relation  $relation
	 * @param  string  $operator
	 * @param  int  $count
	 * @param  string  $boolean
	 ...
	 *
	 * @param  \Fly\Database\Orm\Model  $model
	 * @return \Fly\Database\Orm\Builder
	 */
