...
use Fly\Generators\Generators\ResourceGenerator;
use Fly\Generators\Cache;
...
class ResourceGeneratorCommand extends Command {
     ...
     *
     * @var Fly\Generators\Generators\ResourceGenerator
     */
    protected $generator;
    ...
    public function fire()
    {
        ...
        if (get_called_class() === 'Fly\\Generators\\Commands\\ScaffoldGeneratorCommand')
        {
            $this->generateTest();
        }
