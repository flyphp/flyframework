<?php namespace Fly\Html;

use Fly\Routing\UrlGenerator;
use Fly\Session\Store as Session;
...
class FormBuilder {
	 ...
	 *
	 * @var \Fly\Routing\UrlGenerator  $url
	 */
	protected $url;
	 ...
	 *
	 * @param  \Fly\Routing\UrlGenerator  $url
	 * @param  \Fly\Html\HtmlBuilder  $html
	 ...
	 *
	 * @return  \Fly\Session\Store  $session
	 */
