...
use Fly\Support\SerializableClosure;
...
class Mailer {
	 ...
	 *
	 * @param  \Fly\View\Environment  $views
	 ...
	 *
	 * @param  \Fly\Mail\Message  $message
	 * @param  string  $view
	 * @param  string  $plain
	 * @param  array   $data
	 * @return void
	 ...
	 *
	 * @param  \Fly\Log\Writer  $logger
	 * @return \Fly\Mail\Mailer
	 */
	 ...
	 *
	 * @param  \Fly\Queue\QueueManager  $queue
	 * @return \Fly\Mail\Mailer
	 */
