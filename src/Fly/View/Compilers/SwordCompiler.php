<?php namespace Fly\View\Compilers;

use Closure;

class SwordCompiler extends Compiler implements CompilerInterface {
	...
	/**
	 * Register a custom Sword compiler.
	 *
	...
	/**
	 * Compile Sword template extensions into valid PHP.
	 *
	 * @param  string  $value
	 * @return string
	 */
	...
	{
		// By convention, Sword views using template inheritance must begin with the
	...
	/**
	 * Compile Sword structure openings into valid PHP.
	 *
	 * @param  string  $value
	 * @return string
	 */
	...
	/**
	 * Compile Sword structure closings into valid PHP.
	 *
	 * @param  string  $value
	 * @return string
	 */
	...
	/**
	 * Compile Sword else statements into valid PHP.
	 *
	 * @param  string  $value
	 * @return string
	 */
	...
	/**
	 * Compile Sword unless statements into valid PHP.
	 *
	 * @param  string  $value
	 * @return string
	 */
	...
	/**
	 * Compile Sword end unless statements into valid PHP.
	 *
	 * @param  string  $value
	 * @return string
	 */
	...
	/**
	 * Compile Sword include statements into valid PHP.
	 *
	 * @param  string  $value
	 * @return string
	 */
	...
	/**
	 * Compile Sword each statements into valid PHP.
	 *
	 * @param  string  $value
	 * @return string
	 */
	...
	/**
	 * Compile Sword yield statements into valid PHP.
	 *
	 * @param  string  $value
	 * @return string
	 */
	...
	/**
	 * Compile Sword show statements into valid PHP.
	 *
	 * @param  string  $value
	 * @return string
	 */
	...
	/**
	 * Compile Sword language and language choice statements into valid PHP.
	 *
	 * @param  string  $value
	 * @return string
	 */
	protected function compileLanguage($value)
	{
		...
		$value = preg_replace($pattern, '$1<?php echo \Fly\Support\Facades\Lang::get$2; ?>', $value);

		$pattern = $this->createMatcher('choice');

		return preg_replace($pattern, '$1<?php echo \Fly\Support\Facades\Lang::choice$2; ?>', $value);
	}

	/**
	 * Compile Sword section start statements into valid PHP.
	 *
	 * @param  string  $value
	 * @return string
	 */
	...
	/**
	 * Compile Sword section stop statements into valid PHP.
	 *
	 * @param  string  $value
	 * @return string
	 */
	...
	/**
	 * Compile Sword section append statements into valid PHP.
	 *
	 * @param  string  $value
	 * @return string
	 */
	...
	/**
	 * Get the regular expression for a generic Sword function.
	 *
