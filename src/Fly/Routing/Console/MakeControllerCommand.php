<?php namespace Fly\Routing\Console;
...
class MakeControllerCommand extends Command {
	 ...
	 *
	 * @var \Fly\Routing\Generators\ControllerGenerator
	 */
	protected $generator;
	 ...
	 *
	 * @param  \Fly\Routing\Generators\ControllerGenerator  $generator
	 * @param  string  $path
	 * @return void
	 */
	...
	protected function getPath()
	{
		...
		{
			return $this->flyphp['path.base'].'/'.$this->input->getOption('path');
		}
	...
	{
		$path = $this->flyphp['path.base'].'/workbench/'.$bench.'/src/controllers';

		if ( ! $this->flyphp['files']->isDirectory($path))
		{
			$this->flyphp['files']->makeDirectory($path);
		}
