...
class AssetPublishCommand extends Command {
	 ...
	 *
	 * @var \Fly\Foundation\AssetPublisher
	 */
	protected $assets;
	 ...
	 *
	 * @param  \Fly\Foundation\AssetPublisher  $assets
	 * @return void
	 */
	...
	protected function getPath()
	{
		...
		if ( ! is_null($path))
		{
			return $this->flyphp['path.base'].'/'.$path;
		}
		...
		if ( ! is_null($bench))
		{
			return $this->flyphp['path.base']."/workbench/{$bench}/public";
		}
	}
