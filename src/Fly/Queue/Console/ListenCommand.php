...
class ListenCommand extends Command {
	 ...
	 *
	 * @param  \Fly\Queue\Listener  $listener
	 * @return void
	 */
	...
	protected function getQueue($connection)
	{
		...
		{
			$connection = $this->flyphp['config']['queue.default'];
		}

		$queue = $this->flyphp['config']->get("queue.connections.{$connection}.queue", 'default');
	...
	{
		$this->listener->setEnvironment($this->flyphp->environment());
