...
if ( ! function_exists('app'))
{
	...
	function app($make = null)
	{
		...
		return Fly\Support\Facades\Facade::getFacadeApplication();
	}
}
...
if ( ! function_exists('array_sort'))
{
	...
	{
		return Fly\Support\Collection::make($array)->sortBy($callback)->all();
	}
}
...
if ( ! function_exists('camel_case'))
{
	...
	{
		return Fly\Support\Str::camel($value);
	}
}
...
if ( ! function_exists('ends_with'))
{
	...
	{
		return Fly\Support\Str::endsWith($haystack, $needle);
	}
}
...
if ( ! function_exists('snake_case'))
{
	...
	{
		return Fly\Support\Str::snake($value, $delimiter);
	}
}
...
if ( ! function_exists('starts_with'))
{
	...
	{
		return Fly\Support\Str::startsWith($haystack, $needle);
	}
}
...
if ( ! function_exists('str_contains'))
{
	...
	{
		return Fly\Support\Str::contains($haystack, $needle);
	}
}
...
if ( ! function_exists('str_finish'))
{
	...
	{
		return Fly\Support\Str::finish($value, $cap);
	}
}
...
if ( ! function_exists('str_is'))
{
	...
	{
		return Fly\Support\Str::is($pattern, $value);
	}
}
...
if ( ! function_exists('str_limit'))
{
		...
		{
				return Fly\Support\Str::limit($value, $limit, $end);
		}
}
...
if ( ! function_exists('str_plural'))
{
	...
	{
		return Fly\Support\Str::plural($value, $count);
	}
}
...
if ( ! function_exists('str_random'))
{
	...
	{
		return Fly\Support\Str::random($length);
	}
}
...
if ( ! function_exists('str_singular'))
{
	...
	{
		return Fly\Support\Str::singular($value);
	}
}
...
if ( ! function_exists('studly_case'))
{
	...
	{
		return Fly\Support\Str::studly($value);
	}
}
