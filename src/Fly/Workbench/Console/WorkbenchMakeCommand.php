<?php namespace Fly\Workbench\Console;

use Fly\Console\Command;
use Fly\Workbench\Package;
use Fly\Workbench\PackageCreator;
...
class WorkbenchMakeCommand extends Command {
	 ...
	 *
	 * @var \Fly\Workbench\PackageCreator
	 */
	protected $creator;
	 ...
	 *
	 * @param  \Fly\Workbench\PackageCreator  $creator
	 * @return void
	 */
	 ...
	 *
	 * @param  \Fly\Workbench\Package  $package
	 * @return string
	 */
	protected function runCreator($package)
	{
		$path = $this->flyphp['path.base'].'/workbench';
