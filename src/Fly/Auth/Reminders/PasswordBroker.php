...
use Closure;
use Fly\Mail\Mailer;
use Fly\Auth\UserProviderInterface;
...
class PasswordBroker {
	 ...
	 *
	 * @var \Fly\Auth\Reminders\ReminderRepositoryInterface  $reminders
	 */
	protected $reminders;
	 ...
	 *
	 * @var \Fly\Auth\UserProviderInterface
	 */
	protected $users;
	 ...
	 *
	 * @param  \Fly\Auth\Reminders\ReminderRepositoryInterface  $reminders
	 * @param  \Fly\Auth\UserProviderInterface  $users
	 * @param  \Fly\Mail\Mailer  $mailer
	 ...
	 *
	 * @param  \Fly\Auth\Reminders\RemindableInterface  $user
	 * @param  string   $token
	 * @param  Closure  $callback
	 * @return void
	 */
	 ...
	 *
	 * @param  array  $credentials
	 * @return \Fly\Auth\Reminders\RemindableInterface
	 */
	 ...
	 *
	 * @return \Fly\Auth\Reminders\ReminderRepositoryInterface
	 */
