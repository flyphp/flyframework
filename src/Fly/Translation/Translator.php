<?php namespace Fly\Translation;

use Fly\Support\Collection;
use Fly\Support\NamespacedItemResolver;
...
class Translator extends NamespacedItemResolver implements TranslatorInterface {
	 ...
	 *
	 * @var \Fly\Translation\LoaderInterface
	 */
	protected $loader;
	 ...
	 *
	 * @param  \Fly\Translation\LoaderInterface  $loader
	 * @param  string  $locale
	 * @return void
	 */
	 ...
	 *
	 * @return \Fly\Translation\LoaderInterface
	 */
