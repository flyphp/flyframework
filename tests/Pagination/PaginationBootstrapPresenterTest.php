...
use Mockery as m;
use Fly\Pagination\BootstrapPresenter;
...
class PaginationBootstrapPresenterTest extends PHPUnit_Framework_TestCase {
	...
	{
		$presenter = $this->getMock('Fly\Pagination\BootstrapPresenter', array('getPageRange', 'getPrevious', 'getNext'), array($paginator = $this->getPaginator()));
	...
	{
		$presenter = $this->getMock('Fly\Pagination\BootstrapPresenter', array('getPageRange', 'getPrevious', 'getNext', 'getStart', 'getFinish'), array($paginator = $this->getPaginator()));
	...
	{
		$presenter = $this->getMock('Fly\Pagination\BootstrapPresenter', array('getPageRange'), array($paginator = $this->getPaginator()));
