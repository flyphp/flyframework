...
class FoundationConfigPublisherTest extends PHPUnit_Framework_TestCase {
	...
	{
		$pub = new Fly\Foundation\ConfigPublisher($files = m::mock('Fly\Filesystem\Filesystem'), __DIR__);
		...
		$pub = new Fly\Foundation\ConfigPublisher($files2 = m::mock('Fly\Filesystem\Filesystem'), __DIR__);
