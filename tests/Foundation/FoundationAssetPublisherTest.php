...
class FoundationAssetPublisherTest extends PHPUnit_Framework_TestCase {
	...
	{
		$pub = new Fly\Foundation\AssetPublisher($files = m::mock('Fly\Filesystem\Filesystem'), __DIR__);
	...
	public function testPackageAssetPublishing()
	{
		...
		$pub = new Fly\Foundation\AssetPublisher($files2 = m::mock('Fly\Filesystem\Filesystem'), __DIR__);
