...
class FoundationViewPublisherTest extends PHPUnit_Framework_TestCase {
	...
	{
		$pub = new Fly\Foundation\ViewPublisher($files = m::mock('Fly\Filesystem\Filesystem'), __DIR__);
		...
		$pub = new Fly\Foundation\ViewPublisher($files2 = m::mock('Fly\Filesystem\Filesystem'), __DIR__);
