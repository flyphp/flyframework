...
class DatabaseActiveRecordHasOneTest extends PHPUnit_Framework_TestCase {
	...
	public function testSaveMethodSetsForeignKeyOnModel()
	{
		...
		$mockModel = $this->getMock('Fly\Database\ActiveRecord\Model', array('save'));
	...
	public function testEagerConstraintsAreProperlyAdded()
	{
		...
		$model1 = new ActiveRecordHasOneModelStub;
		$model1->id = 1;
		$model2 = new ActiveRecordHasOneModelStub;
		$model2->id = 2;
	...
	public function testModelsAreProperlyMatchedToParents()
	{
		...
		$result1 = new ActiveRecordHasOneModelStub;
		$result1->foreign_key = 1;
		$result2 = new ActiveRecordHasOneModelStub;
		...
		$model2 = new ActiveRecordHasOneModelStub;
		$model2->id = 2;
		$model3 = new ActiveRecordHasOneModelStub;
		$model3->id = 3;
...
class ActiveRecordHasOneModelStub extends Fly\Database\ActiveRecord\Model {
