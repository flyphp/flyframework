...
class DatabaseActiveRecordCollectionTest extends PHPUnit_Framework_TestCase {
	...
	{
		$mockModel = m::mock('Fly\Database\ActiveRecord\Model');
		$mockModel->shouldReceive('getKey')->andReturn(1);
		$mockModel2 = m::mock('Fly\Database\ActiveRecord\Model');
		$mockModel2->shouldReceive('getKey')->andReturn(2);
		$mockModel3 = m::mock('Fly\Database\ActiveRecord\Model');
	...
	{
		$c = $this->getMock('Fly\Database\ActiveRecord\Collection', array('first'), array(array('foo')));
	...
	{
		$one = m::mock('Fly\Database\ActiveRecord\Model');
		$one->shouldReceive('getKey')->andReturn(1);

		$two = m::mock('Fly\Database\ActiveRecord\Model');
		$two->shouldReceive('getKey')->andReturn(2);

		$three = m::mock('Fly\Database\ActiveRecord\Model');
