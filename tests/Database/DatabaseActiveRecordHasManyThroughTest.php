...
class DatabaseActiveRecordHasManyThroughTest extends PHPUnit_Framework_TestCase {
	...
	public function testEagerConstraintsAreProperlyAdded()
	{
		...
		$model1 = new ActiveRecordHasManyThroughModelStub;
		$model1->id = 1;
		$model2 = new ActiveRecordHasManyThroughModelStub;
		$model2->id = 2;
	...
	public function testModelsAreProperlyMatchedToParents()
	{
		...
		$result1 = new ActiveRecordHasManyThroughModelStub;
		$result1->country_id = 1;
		$result2 = new ActiveRecordHasManyThroughModelStub;
		$result2->country_id = 2;
		$result3 = new ActiveRecordHasManyThroughModelStub;
		...
		$model2 = new ActiveRecordHasManyThroughModelStub;
		$model2->id = 2;
		$model3 = new ActiveRecordHasManyThroughModelStub;
		$model3->id = 3;
...
class ActiveRecordHasManyThroughModelStub extends Fly\Database\ActiveRecord\Model {
