...
class DatabaseMySqlSchemaGrammarTest extends PHPUnit_Framework_TestCase {
	...
	public function testAddingString()
	{
		...
		$blueprint = new Blueprint('users');
		$blueprint->string('foo', 100)->nullable()->default(new Fly\Database\Query\Expression('CURRENT TIMESTAMP'));
		$statements = $blueprint->toSql($this->getConnection(), $this->getGrammar());
	...
	{
		return m::mock('Fly\Database\Connection');
	}


	public function getGrammar()
	{
		return new Fly\Database\Schema\Grammars\MySqlGrammar;
	}
