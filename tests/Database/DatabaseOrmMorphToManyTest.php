...
class DatabaseOrmMorphToManyTest extends PHPUnit_Framework_TestCase {
	...
	public function testEagerConstraintsAreProperlyAdded()
	{
		...
		$model1 = new OrmMorphToManyModelStub;
		$model1->id = 1;
		$model2 = new OrmMorphToManyModelStub;
		$model2->id = 2;
	...
	{
		$relation = $this->getMock('Fly\Database\Orm\Relations\MorphToMany', array('touchIfTouching'), $this->getRelationArguments());
...
class OrmMorphToManyModelStub extends Fly\Database\Orm\Model {
