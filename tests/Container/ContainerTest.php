...
class ContainerContainerTest extends PHPUnit_Framework_TestCase {
	...
	public function testClosureResolution()
	{
		...
		$container->bind('name', function() { return 'Allan'; });
		$this->assertEquals('Allan', $container->make('name'));
	}
	...
	public function testBindIfDoesntRegisterIfServiceAlreadyRegistered()
	{
		$container = new Container;
		$container->bind('name', function() { return 'Allan'; });
		$container->bindIf('name', function() { return 'Silva'; });
	...
	public function testExtendedBindings()
	{
		...
		{
			return (object) array('name' => 'allan');
		});
		$container->extend('foo', function($old, $container)
		{
			$old->age = 26;
		...
		$this->assertEquals('allan', $result->name);
	...
	public function testResolutionOfDefaultParameters()
	{
		...
		$this->assertEquals('allan', $instance->default);
	}
	...
	{
		$container = new Container;
		$container->resolving('foo', function($object) { return $object->name = 'allan'; });
	...
	{
		$container = new Container;
		$container->resolvingAny(function($object) { return $object->name = 'allan'; });
		$container->bind('foo', function() { return new StdClass; });
		$instance = $container->make('foo');
...
class ContainerDefaultValueStub {
	...
	public function __construct(ContainerConcreteStub $stub, $default = 'allan')
	{
		$this->stub = $stub;
