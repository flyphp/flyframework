...
class ConfigRepositoryTest extends PHPUnit_Framework_TestCase {
	...
	{
		$config = $this->getMock('Fly\Config\Repository', array('addNamespace'), array(m::mock('Fly\Config\LoaderInterface'), 'production'));
	...
	{
		return new Fly\Config\Repository(m::mock('Fly\Config\LoaderInterface'), 'production');
	}
