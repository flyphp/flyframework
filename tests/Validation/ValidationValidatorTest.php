...
class ValidationValidatorTest extends PHPUnit_Framework_TestCase {
	...
	public function testHasNotFailedValidationRules()
	{
		...
		$v = new Validator($trans, array('foo' => 'allan'), array('name' => 'Confirmed'));
	...
	{
		$trans = $this->getRealTranslator();
		$v = new Validator($trans, array('first' => 'Allan'), array('last' => 'required_with:first'));
		$this->assertFalse($v->passes());

		$v = new Validator($trans, array('first' => 'Allan', 'last' => ''), array('last' => 'required_with:first'));
		$this->assertFalse($v->passes());
		...
		$v = new Validator($trans, array('first' => 'Allan', 'last' => 'Freitas'), array('last' => 'required_with:first'));
		$this->assertTrue($v->passes());
	...
	{
		$trans = $this->getRealTranslator();
		$v = new Validator($trans, array('first' => 'Allan'), array('last' => 'required_without:first'));
		$this->assertTrue($v->passes());

		$v = new Validator($trans, array('first' => 'Allan', 'last' => ''), array('last' => 'required_without:first'));
		$this->assertTrue($v->passes());
		...
		$v = new Validator($trans, array('first' => 'Allan', 'last' => 'Freitas'), array('last' => 'required_without:first'));
		$this->assertTrue($v->passes());

		$v = new Validator($trans, array('last' => 'Freitas'), array('last' => 'required_without:first'));
		$this->assertTrue($v->passes());
	...
	{
		$trans = $this->getRealTranslator();
		$v = new Validator($trans, array('first' => 'allan'), array('last' => 'required_if:first,allan'));
		$this->assertTrue($v->fails());

		$trans = $this->getRealTranslator();
		$v = new Validator($trans, array('first' => 'allan', 'last' => 'freitas'), array('last' => 'required_if:first,allan'));
		$this->assertTrue($v->passes());
	}
	...
	public function testValidateUnique()
	{
		...
		$mock = m::mock('Fly\Validation\PresenceVerifierInterface');
		...
		$mock2 = m::mock('Fly\Validation\PresenceVerifierInterface');
		...
		$mock3 = m::mock('Fly\Validation\PresenceVerifierInterface');
	...
	public function testValidationExists()
	{
		...
		$trans = $this->getRealTranslator();
		$v = new Validator($trans, array('email' => 'foo'), array('email' => 'Exists:users,email,account_id,1,name,allan'));
		$mock4 = m::mock('Fly\Validation\PresenceVerifierInterface');
		$mock4->shouldReceive('getCount')->once()->with('users', 'email', 'foo', null, null, array('account_id' => 1, 'name' => 'allan'))->andReturn(true);
...
1'), array('x' => 'Alpha'));
	...
	public function testCustomValidators()
	{
		$trans = $this->getRealTranslator();
		$trans->addResource('array', array('validation.foo' => 'foo!'), 'en', 'messages');
		$v = new Validator($trans, array('name' => 'allan'), array('name' => 'foo'));
		...
		$v = new Validator($trans, array('name' => 'allan'), array('name' => 'foo_bar'));
