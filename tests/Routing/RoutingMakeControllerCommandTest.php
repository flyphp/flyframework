...
class RoutingMakeControllerCommandTest extends PHPUnit_Framework_TestCase {
	...
	{
		$command = new Fly\Routing\Console\MakeControllerCommand($gen = m::mock('Fly\Routing\Generators\ControllerGenerator'), __DIR__);
	...
	public function testGeneratorIsCalledWithProperOptionsForExceptAndOnly()
	{
		...
		$command->setFlyphp(array('path.base' => __DIR__.'/foo'));
