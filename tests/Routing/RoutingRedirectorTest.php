...
class RoutingRedirectorTest extends PHPUnit_Framework_TestCase {
	...
	public function setUp()
	{
		...
		$this->request = m::mock('Fly\Http\Request');
		$this->request->headers = $this->headers;

		$this->url = m::mock('Fly\Routing\UrlGenerator');
		...
		$this->session = m::mock('Fly\Session\Store');
	...
	public function testBasicRedirectTo()
	{
		...
		$this->assertInstanceOf('Fly\Http\RedirectResponse', $response);
