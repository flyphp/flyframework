...
class MailMessageTest extends PHPUnit_Framework_TestCase {
	...
	public function testBasicAttachment()
	{
		...
		$message = $this->getMock('Fly\Mail\Message', array('createAttachmentFromPath'), array($swift));
	...
	{
		$swift = m::mock('StdClass');
		$message = $this->getMock('Fly\Mail\Message', array('createAttachmentFromData'), array($swift));
		$attachment = m::mock('StdClass');
