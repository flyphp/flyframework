...
class CacheApcStoreTest extends PHPUnit_Framework_TestCase {
	...
	public function testAPCValueIsReturned()
	{
		...
		$store = new Fly\Cache\ApcStore($apc);
	...
	{
		$apc = $this->getMock('Fly\Cache\ApcWrapper', array('put'));
	...
	{
		$apc = $this->getMock('Fly\Cache\ApcWrapper', array('increment'));
	...
	{
		$apc = $this->getMock('Fly\Cache\ApcWrapper', array('decrement'));
	...
	{
		$apc = $this->getMock('Fly\Cache\ApcWrapper', array('delete'));
