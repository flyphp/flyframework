...
class AuthActiveRecordUserProviderTest extends PHPUnit_Framework_TestCase {
	...
	public function testCredentialValidation()
	{
		...
		$provider = new Fly\Auth\ActiveRecordUserProvider($hasher, 'foo');
	...
	public function testModelsCanBeCreated()
	{
		$conn = m::mock('Fly\Database\Connection');
		$hasher = m::mock('Fly\Hashing\HasherInterface');
		$provider = new Fly\Auth\ActiveRecordUserProvider($hasher, 'ActiveRecordProviderUserStub');
		$model = $provider->createModel();

		$this->assertInstanceOf('ActiveRecordProviderUserStub', $model);
	}
	...
	{
		$hasher = m::mock('Fly\Hashing\HasherInterface');
		return $this->getMock('Fly\Auth\ActiveRecordUserProvider', 
			array('createModel'), array($hasher, 'foo'));
	}

}

class ActiveRecordProviderUserStub {}